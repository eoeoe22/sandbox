...
- [MATERIAL-ICONS.md](./MATERIAL-ICONS.md) — 물질 아이콘·패턴(**계획 단계**): 단색 스와치를 캔버스의 실제 질감(틴트 노이즈·격자·화살표·glow 램프)으로 바꾸는 설계, 팔레트 126종 전수 분류(B1~B10), 채택 seam과 기각 대안, 미해결 결정 사항. 에셋 저작 지침은 `.claude/skills/create-svg-assets/`.
