// Bundles and runs the 로켓 캔디 harness (test/rocketcandy.ts) under Node,
...
const out = join(__dirname, '..', 'node_modules', '.cache', 'rocketcandy.bundle.mjs');
...
await build({
  entryPoints: [join(__dirname, 'rocketcandy.ts')],
  bundle: true,
  platform: 'node',
  format: 'esm',
  outfile: out,
