...
export const materialCodexEn: Record<number, string> = {
  ...
  146: 'A fish that swims through liquid. It gives way when another fish gets too close and otherwise goes its own way. Out of water it flops about and suffocates in roughly 12 seconds; heat, blast shockwaves and radiation kill it too. Water conducts, so a current running through a tank electrocutes half the fish in it. It leaves a dead fish that floats to the surface.',
