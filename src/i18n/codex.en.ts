...
export const materialCodexEn: Record<number, string> = {
  ...
  11: 'Corrodes solids and powders. Boils into acid vapor and freezes at -20°C. Corroding a metal above hydrogen in the reactivity series produces hydrogen bubbles. On contact with slime it is spent a cell at a time, turning it into acid slime.',
  ...
  115: 'The variant acid makes of slime, corroding just as hard as the acid itself. Half of the water it absorbs comes back as plain slime, and water can rinse the acid out of it entirely.',
