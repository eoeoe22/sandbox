...
const SHOCK_SPEED = 1.2; // cells the wavefront advances per rendered frame (2× faster so a
// rapid emitter like a Turbine reads as moving rings, not a packed disc)
const SHOCK_THICK = 1.2; // wavefront thickness in cells — a thin ~1-particle-wide line; kept
// equal to SHOCK_SPEED so the faster front still tiles every distance (no radial gaps)
