...
// floats on water. It's flammable but the most reluctant, tarry fuel there is: at
// the lowest burnChance of any combustible it catches grudgingly and, once alight,
// creeps and smoulders for a very long time rather than flashing off — a lit
// runnel oozes flame along itself slowly for ages (burnChance sets both the spread
// pace and the per-cell burn life, so a low value stretches both). Left to itself
// it slowly cures: each tick a small chance to harden in place into solid Amber
// (see amber.ts), so a poured runnel of resin gradually sets into a glassy gold
// solid — drip it over something and it freezes the moment into amber. Heat it and
// it burns before it can set; leave it cold and it hardens.
