...
// pinned under it like solid ground (updatePowder's built-in buoyancy check).
// The *second-fastest* fuel — behind Gasoline, ahead of Wood — because loose,
// airy shavings catch far more readily than the solid timber they were milled
// from: a higher ignite chance than the solids and a modest autoignition
// point, though it still burns as a creeping front rather than a flash. A
