...
//
// Two departures from a plain powder: it moves with the floaty-powder drift
// (updateFloatyPowder) rather than a straight fall — stalling and swaying
// sideways so flakes scatter down like real snow instead of dropping like sand
// — and its conductivity is low (fluffy snow insulates) so it holds its cold
// and melts slowly against warm neighbors.
