 ...
 *
 * Read-only, including the acid: eating a *cell* costs the puddle a cell back,
 * 1:1 (the shared corrosion pass in materials/corrosion.ts), but dissolving a
 * body takes nothing out of it. The object
